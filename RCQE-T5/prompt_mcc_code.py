...
import bleu
from tools_code import read_prompt_examples, get_elapse_time
...
def read_arguments():
	...
	parser.add_argument("--output_dir", default="./mcc_model_code", type=str, required=False,
...
def main(args):
	...
	promptTemplate = PrefixTuningTemplate(model=plm, tokenizer=tokenizer,
                text='{"placeholder":"text_a"}  {"placeholder":"text_b"} The New Code change is {"mask"} ', using_decoder_past_key_values=False, num_token=200)
